...
class DataSetWrapper(object):
    ...
    def get_data_loaders(self):
        ...
        train_dataset = EyeDataset(csv_file='./raw_dataset/train.csv',root_dir='./raw_dataset/train/', #change the roo dir
                                       transform=SimCLRDataTransform(data_augment))

        valid_dataset = EyeDataset(csv_file='./raw_dataset/valid.csv',root_dir='./raw_dataset/valid/', #change the root dir
                                       transform=SimCLRDataTransform(data_augment))
