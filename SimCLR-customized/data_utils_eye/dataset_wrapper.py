...
from data_utils_eye.gaussian_blur import GaussianBlur
from data_utils_eye.eye_augmentation import CustomZoom
import pandas as pd
#dataset classe
from data_utils_eye.eye_data import EyeDataset
...
class DataSetWrapper(object):
    ...
    def get_data_loaders(self):
        ...
        # train_dataset = EyeDataset(csv_file='./raw_dataset/train.csv',root_dir='./raw_dataset/train/',
        #                                transform=SimCLRDataTransform(data_augment))

        # valid_dataset = EyeDataset(csv_file='./raw_dataset/valid.csv',root_dir='./raw_dataset/valid/',
        #                                transform=SimCLRDataTransform(data_augment))
